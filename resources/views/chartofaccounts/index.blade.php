@extends('layouts.app', ['page' => 'chartofaccount', 'pageSlug' => 'chartofaccount', 'section' => 'chartofaccount'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('chartofaccounts.create') }}" class="btn btn-sm btn-primary">Add Account</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
